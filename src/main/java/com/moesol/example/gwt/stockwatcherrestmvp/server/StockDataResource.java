...
public class StockDataResource
{
    ...
    public StockDataResourceBean getStockDataFor(@QueryParam("q") String symbols)
    {
        StockDataResourceBean result;
        if(null == symbols || symbols.trim().equals(""))
            result = new StockDataResourceBean(new String[] {});
        else
            result = new StockDataResourceBean(symbols.split(","));
