 ...
 */
@ApplicationPath("stockWatcher")
public class StockDataRestApplication extends Application
{
    @Override
    public Set<Class<?>> getClasses()
    {
        Set<Class<?>> resources = new HashSet<Class<?>>();
        resources.add(StockDataResource.class);
        resources.add(StockDataResourceBean.class);
        return resources;
    }
}
